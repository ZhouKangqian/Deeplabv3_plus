...
class U_Net_SEAttention(nn.Module):  # 添加了空间注意力和通道注意力
    def __init__(self, img_ch=3, output_ch=6,num_classes=6 ):   #在图像分割任务中，输出通道数通常等于类别数，所以原来的输出通道数是2，被改成了6
        super(U_Net_SEAttention, self).__init__()
        ...
        self.cbam1 = SELayer(channel=64)
        self.cbam2 = SELayer(channel=128)
        self.cbam3 = SELayer(channel=256)
        self.cbam4 = SELayer(channel=512)
